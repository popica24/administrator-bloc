...
describe("listaPdf pentru avizier", () => {
  it("lista curenta: coloanele de restante, penalizari si total de plata", async () => {
    ...
    expect(t).toContain("Asociatia de proprietari nr. 118, Bloc D14, scara A. Lista generata din AdminBloc pe 19 septembrie 2026.  |  pagina 1");
    /* ordinea apartamentelor este numerica: 2 inainte de 10 */
    expect(t.indexOf("\n2\nAna Petrescu")).toBeLessThan(t.indexOf("\n10\nSanda Croitoru"));
  });

  it("o lista trecuta nu are coloane de restante; nume lungi taiate, factura fara serie", async () => {
    await pornesteApp({
      email: ADMIN,
      modifica: (d) => {
